...
const QuizNo16 = () => {
  ...
  useEffect(() => {
    if (kg != null) {
      setBenifits(Math.round(100 - (kg / radioValues[15].kg) * 100));
    } else {
      setBenifits(Math.round(100 - (Lbs / 2.20462 / radioValues[15].kg) * 100));
    }
  }, [kg, Lbs]);
  ...
  useEffect(() => {
    if (
      kg <=
      Math.round(19 * ((radioValues[14].cm / 100) * (radioValues[14].cm / 100)))
    ) {
      setDisplayBenifits(
        <div className="flex justify-center items-center text-left mt-4">
          <div className="flex-col max-w-[400px] pb-2 pl-5 pr-5 pt-2 rounded-md border-2 border-red-300">
            ...
            <p className="text-gray-400 text-base">
              ...
              {Math.round(
                19 * ((radioValues[14].cm / 100) * (radioValues[14].cm / 100))
              )}{" "}
              kg and{" "}
              {Math.round(
                25 * ((radioValues[14].cm / 100) * (radioValues[14].cm / 100))
              )}{" "}
              kg. Any weight below{" "}
              {Math.round(
                19 * ((radioValues[14].cm / 100) * (radioValues[14].cm / 100))
