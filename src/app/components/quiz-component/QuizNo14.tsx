...
const QuizNo14 = () => {
  ...
  return (
    ...
    <div className="flex-col justify-center items-center text-center ">
      ...
      Are you out of breath after <br /> walking up a flight of <br /> stairs?
      </h1>
    </div>
        ...
        <Label
          ...
          >
            <img
              ...
              alt="very-hard-img"
            />
            <h1 className="pr-[40px]  font-semibold text-base ">I'm so out of breath I can't talk</h1>
            <RadioGroupItem className="mr-5 " value="I'm so out of breath I can't talk" id="r1" />
          </Label>
          ...
          >
            ...
            <h1 className="pr-[40px]  font-semibold text-base">I'm somewhat out of breath but can talk</h1>
            <RadioGroupItem className="mr-5" value="I'm somewhat out of breath but can talk" id="r2" />
          </Label>
          <Label
          ...
          >
            ...
            <h1 className="pr-[40px]  font-semibold text-base">I'm OK after one flight of stairs</h1>
            <RadioGroupItem className="mr-5" value="I'm OK after one flight of stairs" id="r3" />
          </Label>
          <Label
          ...
          >
            ...
            <h1 className="pr-[40px]  font-semibold text-base">I can easily walk up a few flights of stairs</h1>
            <RadioGroupItem className="mr-5" value="I can easily walk up a few flights of stairs" id="r4" />
          </Label>
      </RadioGroup>
    </div>
    <Footer />
