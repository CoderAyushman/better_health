...
const QuizNo15 = () => {
  ...
  return (
    ...
    <div className="flex-col justify-center items-center text-center ">
      ...
      How many <a href="https://en.wikipedia.org/wiki/Squat_(exercise)#:~:text=A%20squat%20is%20a%20strength,joint%20plantarflexes%20when%20standing%20up." target="_blank">squats</a> can you <br /> do?
      </h1>
    </div>
        ...
        <Label
          ...
          >
            <img
              ...
              alt="very-hard-img"
            />
            <h1 className="pr-[100px]  font-semibold text-base ">Fewer than 20</h1>
          ...
          >
            ...
            <h1 className="pr-[100px]  font-semibold text-base">20-35</h1>
          ...
          >
            ...
            <h1 className="pr-[100px]  font-semibold text-base">More than 35</h1>
          ...
          >
            ...
            <h1 className="pr-[100px]  font-semibold text-base">I don’t know</h1>
